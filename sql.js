...
//https://stackoverflow.com/questions/54963965/updating-a-value-in-sql-better-sqlite3-with-node-js
//https://codesandbox.io/s/v6r8w9r14y?file=/src/db.js
...
function adduser(db, userid, friendlyname, emailaddress, admin) {
	...
	try { //wrap the instruction in a try/catch to protect the process
		...
		run_statement.exclusive([
			...
			// 	{ userid: 1000, friendlyname: 'Abraham Lincoln', emailaddress: 'abraham@ada.ac.uk', admin: 1 },
		]);
...
// console.log(row.emailaddress, row.friendlyname, row.userid);
